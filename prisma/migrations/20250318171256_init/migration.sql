...
-- CreateIndex
CREATE UNIQUE INDEX "EsoterikoMelos_id_epafis_key" ON "EsoterikoMelos"("id_epafis");

-- CreateIndex
CREATE UNIQUE INDEX "EsoterikoMelos_arithmos_mitroou_key" ON "EsoterikoMelos"("arithmos_mitroou");

-- CreateIndex
CREATE UNIQUE INDEX "EksoterikoMelos_id_epafis_key" ON "EksoterikoMelos"("id_epafis");
...
-- AddForeignKey
ALTER TABLE "EsoterikoMelos" ADD CONSTRAINT "EsoterikoMelos_id_epafis_fkey" FOREIGN KEY ("id_epafis") REFERENCES "Epafes"("id_epafis") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EksoterikoMelos" ADD CONSTRAINT "EksoterikoMelos_id_epafis_fkey" FOREIGN KEY ("id_epafis") REFERENCES "Epafes"("id_epafis") ON DELETE CASCADE ON UPDATE CASCADE;
